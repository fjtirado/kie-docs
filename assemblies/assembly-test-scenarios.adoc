...
.Prerequisites
* The space and project for the decision service have been created in {CENTRAL}. For details, see {URL_GETTING_STARTED_DECISION_SERVICE}[_{GETTING_STARTED_DECISION_SERVICE}_].
