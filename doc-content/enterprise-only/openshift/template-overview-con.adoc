...
For reference information about other templates used in this environment, see {URL_DEPLOYING_IMMUTABLE_ON_OPENSHIFT}/template-overview-con_{context}#template-overview-con_{context}[the reference section in _{DEPLOYING_IMMUTABLE_ON_OPENSHIFT}_].
endif::[]
endif::PAM[]
ifdef::DM[]
