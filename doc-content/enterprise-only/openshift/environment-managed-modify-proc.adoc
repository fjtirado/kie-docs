...
To adjust the managed environment to your needs, you need to modify the  `{PRODUCT_INIT}{ENTERPRISE_VERSION_SHORT}-prod.yaml` template before deploying the environment.
